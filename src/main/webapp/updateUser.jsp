...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="text-align: center;">
            <form class="form-inline" action="${pageContext.request.contextPath}/user/updateUser.do" method="get">
                <table class="table  table-bordered" style="width:100%;">
                    <tr class="bg-info">
                        <td style="text-align: center;" colspan="2"><span style="font-size: 20px;font-weight: bold;">用户修改</span>
                        </td>
                    </tr>
                    ...
                    <tr class="active">
                        ...
                        <td><input type="text" style="width: 100%;" class="form-control"
                                   name="pwd" value="${requestScope.user.pwd}"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="submit" style="width: 200px;" class="btn btn-success" value="修改">
                        </td>
                    </tr>
                </table>
            </form>
